                                    ...
                                    <div class="col-md-6">
                                        <div class="card-body ">
                                            <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <a href="{{ Route('admin.product.add')}}" class="btn btn-success float-end">Add New Technician</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-body pb-30 pt-30">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h4 class="pb-3 mt-10 mb-10">Are you sure, you want to delete this Technician ?</h4>
