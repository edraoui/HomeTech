                        ...
                        <div class="card" style="width: 50%">
                            <div class="class-header mt-15 mb-15 ml-15 mr-15">
                                <div class="row flex align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ Route('admin.products')}}" class="btn btn-success float-end">All Technicians</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card_body">
                                ...
                                <form class="ml-15 mr-15" wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="regular_price" class="form-label">Price per hour :</label>
                                        <input type="text" name ="regular_price" class="form-control" placeholder="Enter price hour" wire:model="regular_price" >
                                        @error('regular_price')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name ="sale_price" class="form-control" placeholder="Enter Phone" wire:model="sale_price" >
                                        @error('sale_price')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="stock_status" class="form-label" wire:model="stock_status">Status :</label>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="quantity" class="form-label">Tasks achieved  :</label>
                                        <input type="text" name ="quantity" class="form-control" placeholder="Enter Tasks achieved " wire:model="quantity" >
                                        @error('quantity')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
