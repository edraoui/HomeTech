                    ...
                    <div class="col-xl-6 col-lg-4 ">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Welcomo to <a href="{{Route('shop')}}">View details</a></li>
                                    <li> HomeTech<a href="{{Route('shop')}}">Visite now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="header-wrap">
                    <div class="main-categori-wrap d-none d-lg-block">
                        <a class="categori-button-active" href="#">
                             Home<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M352 320c88.4 0 160-71.6 160-160c0-15.3-2.2-30.1-6.2-44.2c-3.1-10.8-16.4-13.2-24.3-5.3l-76.8 76.8c-3 3-7.1 4.7-11.3 4.7H336c-8.8 0-16-7.2-16-16V118.6c0-4.2 1.7-8.3 4.7-11.3l76.8-76.8c7.9-7.9 5.4-21.2-5.3-24.3C382.1 2.2 367.3 0 352 0C263.6 0 192 71.6 192 160c0 19.1 3.4 37.5 9.5 54.5L19.9 396.1C7.2 408.8 0 426.1 0 444.1C0 481.6 30.4 512 67.9 512c18 0 35.3-7.2 48-19.9L297.5 310.5c17 6.2 35.4 9.5 54.5 9.5zM80 408a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg>  Tech
                        </a>
                    </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{ Route('shop')}}">Services</a></li>
                                        ...
                                        <li><a href="{{Route('admin.dashboard')}}">My Account<i class="fi-rs-angle-down"></i></a>
                                            @if (Auth::user()->utype === 'ADM')
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="{{Route('admin.products')}}">Technicians</a></li>
                                                    <li><a href="{{Route('admin.categories')}}">Services</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>hometechtetouan@gmail.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">HomeTech</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
